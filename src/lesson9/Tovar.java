...
public class Tovar {
    // первым делом прописываем поля класса то что важно относительно этого объекта
    ...
    // 2 конструкторы - это особый методот который вызывается после слова new и рождает новый объект
